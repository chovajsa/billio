...
// var_dump(iban_get_parts('SK8031000000004150047806'));
// echo iban_mod97_10(iban_checksum_string_replace('31000000004150047806SK80'));
// echo iban_find_checksum('SK8031000000004150047806');
// echo iban_find_checksum('SK0009000000005050070421');
// echo iban_set_checksum('SK0065000000000020536451'); //Poštová Banka, a.s. SK7965000000000020536451
// echo iban_set_checksum('SK0056000000001147411001'); //Prima Banka, a.s. SK8956000000001147411001
// echo iban_set_checksum('SK0075000000004019047798'); //ČSOB  a.s. SK5475000000004019047798
// echo iban_set_checksum('SK0011110000001233059008'); //UNICREDIT BANK SLOVAKIA, a.s. SK9511110000001233059008
?>
