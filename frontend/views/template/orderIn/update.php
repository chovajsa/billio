	    ...
	    <div class="panel-body">
			<form class="form-horizontal" role="form">
				...
				<label for="supplierId" class="col-sm-2 control-label">Supplier</label>
					<div class="col-sm-10">
						<p class="input-group">
							...
							<input ui-select2="select2Options" ng-model="currentOrder.supplierId" required class="form-control selectpicker bigdrop" data-style="btn-white" type="hidden" id="supplierId"/>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
					  <input id="number" required ng-model="currentOrder.number" class="form-control" type="text">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
					  <input id="referenceNumber" ng-model="currentOrder.referenceNumber" required class="form-control" type="text">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input class="form-control datepicker" ng-model="currentOrder.date" type="text" id="date" name="input1"/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10 input-append">
					  <!-- <p class="input-group"> -->
					  	<input class="form-control datepicker" ng-model="currentOrder.dueDate" type="text" id="dueDate" name="input1">
					  	<!-- <span class="input-group-btn add-on"> -->
