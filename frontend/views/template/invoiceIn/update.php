	...
	<div ng-cloak class="col-md-8 ui-sortable updateInvoice">
		...
		<div class="panel panel-inverse">
			...
			<div class="panel-body">
				<table class="table table-hover">
					...
					<tbody>
						<tr ng-repeat="row in currentInvoice.rows">
							...
							<td width="5%">
								<a ng-show="!currentInvoice.approvedBy.length" href="javascript:void(0)" ng-click="unsetRow($index)">
				...
				<p>
			        <a ng-show="!currentInvoice.approvedBy.length" href="javascript:;" ng-click="addRow()" class="btn btn-sm btn-primary m-r-5"> <i class="fa fa-plus-circle"></i> Add row </a>
			    </p>
			</div>
		</div>
